...
// react-native-maps красит полилинию одним цветом, а сотни отдельных полилиний
// ощутимо тормозят карту. Поэтому квантуем ветер в несколько уровней и склеиваем
// соседние сегменты одного уровня в один кусок.
