...
// <ImageSource> в MapLibre кладёт картинку по четырём углам и растягивает её со
// сглаживанием — получается плавное поле, которого не добиться сеткой полигонов.
//
// Картинка отдаётся байтами, а не data-URI: источник принимает только адрес,
// поэтому PNG пишется во временный файл.
//
